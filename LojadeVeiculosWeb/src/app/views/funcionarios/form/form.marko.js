...
function render(input, out, __component, component, state) {
  ...
  out.w("<section class=form-row><input type=hidden id=id name=id" +
    ...
    "></article><article class=\"col-md-3 mb-3\"><label>CPF</label><input class=form-control type=number id=cpf maxlength=10 name=cpf" +
    marko_attr("value", data.funcionario.cpf) +
    "></article></section><section class=\"form-row mt-2\"><article class=\"col-md-4 mb-4\"><label>Idade</label><input type=text class=form-control id=idade maxlength=2 name=idade" +
    ...
    "></article></section><section class=\"form-row float-sm-right mt-2\"><article class=col><button class=\"btn btn-success ml-2\" type=submit>Cadastrar</button></article></section></form></article></section></aside></article></section><section class=\"col-lg-2 col-md-2 p-0 m-0\"><article class=\"border-right sticky-top\" id=sidebar-wrapper> <nav class=\"list-group list-group-flush\"><a class=\"nav_logo mt-4\"><img class=\"nav__logo logo--user\" src=./../../estatico/imgs/logo_usuario.svg></a><a href=/funcionarios class=nav_link> <h6 class=\"nav-nome mt-1\">Lista de Funcionários</h6></a><a href=/funcionarios/form class=\"nav_link active\"><h6 class=\"nav-nome mt-1\">Cadastrar Funcionários</h6></a><a href=/produtos class=nav_link><h6 class=\"nav-nome mt-1\">Lista de Veiculos</h6></a><a href=/produtos/form class=nav_link><h6 class=\"nav-nome mt-1\">Cadastrar Veiculos</h6></a></nav></article></section></main><footer class=rodape>Desenvolvido pela Equipe 9; Yuri,Gabriel,Mateus,Rafael,Robson.</footer><script>\r\n    $(\"#menu-toggle\").click(function (e) {\r\n      e.preventDefault();\r\n      $(\"#wrapper\").toggleClass(\"toggled\");\r\n    });\r\n  </script><style>\r\n    @media all {\r\n\r\n      img.nav__logo {\r\n        max-height: 100px;\r\n        margin: 0 auto;\r\n        position: relative;\r\n        display: block;\r\n      }\r\n\r\n    }\r\n  </style>");
